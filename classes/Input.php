...
class Input
{
    //Метод, в качестве аргумента принимает строку, характеризующую метод передачи формы на сервер.
    ...
    // Метод проверяет наличие в суперглобальных массивах $_POST и $_GET соответствующего элемента.
    // Если элемени найден, то возвращается его значение(содержание), в противном случае возвращается 
    //пустая строка ''
